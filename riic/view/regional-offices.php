    ...
    <div class="modal-content">
    	<form class="" id="saveOffice" method="POST">
			...
			<div class="modal-body">
			    ...
			    <div class="col-auto">
			    	<label class="form-label h6">Office Name:</label>
			        <input type="text" id="officeName" name="officeName" class="form-control" required>
			    </div>
			    <div class="col-auto">
			    	<label class="form-label h6">Office Code (example: DOST):</label>
			...
			<div class="modal-footer">
				<input type='text' id="databases" value="<?php echo $_GET['token'];?>" readonly><button type="submit" id="submitOffice" class="btn btn-danger"><span class="fa fa-save"></span> Save</button>
